...
('Night Vision','Positive','Brewed','3:00',
 ...
 N'<b>Brewing chain:</b><br>Awkward Potion → +Golden Carrot → Night Vision (3:00)<br>Night Vision → +Redstone → Night Vision Extended (8:00)<br>Night Vision → +Fermented Spider Eye → Invisibility (corruption path)<br><br><b>Golden Carrot craft:</b> 1 Carrot + 8 Gold Nuggets.<br><br><b>Best combo:</b> Night Vision + Water Breathing for ocean monument raids. Coral reefs also become breathtaking with this active.',
...
('Invisibility','Positive','Brewed','3:00',
 ...
 N'<b>Brewing chain:</b><br>First brew Night Vision (Awkward + Golden Carrot)<br>Night Vision → +Fermented Spider Eye → Invisibility (3:00)<br>Invisibility → +Redstone → Invisibility Extended (8:00)<br><br><b>Armor warning:</b> If ANY armor is visible on your body, mobs can detect you within 8–16 blocks.<br><br><b>Fermented Spider Eye craft:</b> Spider Eye + Brown Mushroom + Sugar.<br><br><b>Stealth tip:</b> Combine with Sneaking to avoid making sound near Wardens.',
...
('Leaping','Positive','Brewed','3:00 (I) / 1:30 (II)',
 ...
 N'<b>Brewing chain:</b><br>Awkward Potion → +Rabbit''s Foot → Leaping I (3:00)<br>Leaping I → +Redstone → Leaping I Extended (8:00)<br>Leaping I → +Glowstone Dust → Leaping II (1:30)<br>Leaping (any) → +Fermented Spider Eye → Slowness<br><br><b>Rabbit''s Foot source:</b> Dropped by Rabbits (10% base chance, +3% per Looting level).<br><br><b>Leaping II jump height:</b> Just over 1.25 blocks, enough to clear 2-block-high obstacles.',
...
('Poison','Negative','Splash','0:45 (I) / 0:22 (II)',
 ...
 N'<b>Brewing chain:</b><br>Awkward Potion → +Spider Eye → Poison I (0:45)<br>Poison I → +Redstone → Poison I Extended (1:30)<br>Poison I → +Glowstone Dust → Poison II (0:22)<br>Any Poison → +Gunpowder → Splash Potion<br><br><b>Spider Eye source:</b> Spiders and Cave Spiders (50% drop rate).<br><br><b>Important:</b> Poison does NOT affect undead mobs. Use Harming for zombies and skeletons instead.',
...
('Harming','Negative','Splash','Instant',
 ...
 N'<b>Brewing chain:</b><br>Potion of Healing II → +Fermented Spider Eye → Harming I<br>Potion of Poison → +Fermented Spider Eye → Harming I<br>Harming I → +Glowstone Dust → Harming II (12 instant damage!)<br>Any Harming → +Gunpowder → Splash Potion<br><br><b>Reverse mechanic:</b> Harming HEALS undead mobs. Avoid using on zombies/skeletons.<br><br><b>PvP damage:</b> Harming II splash = 12 damage in a radius. Bypasses armour reduction unlike melee.',
...
('Slowness','Negative','Splash','1:30 (I)',
 ...
 N'<b>Brewing chain:</b><br>Speed Potion → +Fermented Spider Eye → Slowness I (1:30)<br>Leaping Potion → +Fermented Spider Eye → Slowness I (1:30)<br>Slowness I → +Glowstone Dust → Slowness IV (0:20)<br>Any Slowness → +Gunpowder → Splash → +Dragon''s Breath → Lingering<br><br><b>Lingering use:</b> Place a Lingering Potion of Slowness IV on a chokepoint. Enemies walking through receive Slowness IV and cannot escape.',
...
('Decay (Bedrock)','Negative','Splash','0:40',
 ...
 N'<b>Bedrock brewing:</b> Awkward Potion + Wither Rose → Potion of Decay<br><br><b>Wither effect details:</b><br>- Deals 1 HP damage per second<br>- Turns hearts black (making it hard to see real HP)<br>- Bypasses armour entirely (only Wither Resistance from the boss fight reduces it)<br>- Milk bucket cures it instantly<br><br><b>Java equivalent:</b> Wither II is applied by Wither Skeletons on melee hit. No potion equivalent in Java Edition.',
